...
class SqlConnection {
  ...
  Future<bool> open() async {
    ...
    String json2 = json.encode({"type": "open", "text": _connectionString});

    _SendCommand(json2).then((result) {
  ...
  Future<bool> close() {
    ...
    String json2 = json.encode({"type": "close", "text": ""});

    _SendCommand(json2).then((risp) {
  ...
  Future<Table> queryTable(String SQL) {
    ...
    String json2 = json.encode({"type": "table", "text": SQL});
  ...
  Future<PostBackResponse> postBack(ChangeSet chg) {
    ...
    String json2 = json.encode({"type": "postback", "text": params});
  ...
  Future<List<Map<String, dynamic>>> query(String SQL) {
    ...
    String json2 = json.encode({"type": "query", "text": SQL});
  ...
  Future<Map<String, dynamic>> querySingle(String SQL) {
    ...
    String json2 = json.encode({"type": "querysingle", "text": SQL});
  ...
  Future<dynamic> queryValue(String SQL) {
    ...
    String json2 = json.encode({"type": "queryvalue", "text": SQL});
  ...
  Future<int> execute(String SQL) {
    ...
    String json2 = json.encode({"type": "execute", "text": SQL});
  ...
  dynamic _parseResult(String json2) {
    Map result = json.decode(json2);
